...
select * from calisanlar; -- tablosu içib birleşme işyeri sütunu

select * from markalar; -- tablosu için birleşme yer marka_isim sütunu
-- in kullancaksaniz parantez içine aldiğiniz sorgu bizden 
